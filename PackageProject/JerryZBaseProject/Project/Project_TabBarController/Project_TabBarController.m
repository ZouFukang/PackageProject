//
//  Project_TabBarController.m
//  PackageProject
//
//  Created by 邹复康 on 2020/4/27.
//  Copyright © 2020 JerryZ. All rights reserved.
//

#import "Project_TabBarController.h"

@interface Project_TabBarController ()<UITabBarControllerDelegate>

@property (nonatomic, strong) Project_TabBar *projectTabBar;
...
@implementation Project_TabBarController
...
- (void)customTabBarConfiguration {
    ...
    self.projectTabBar = [[Project_TabBar alloc] init];
