//
//  UIViewController+DefaultConfigure.m
//  MyProject
//
...
#import "UIViewController+DefaultConfigure.h"
...
@implementation UIViewController (DefaultConfigure)
...
+ (void)load {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [self swizzlingWithOriginalSelector:@selector(loadView) swizzledSelector:@selector(zfc_loadView)];
        [self swizzlingWithOriginalSelector:@selector(viewDidLoad) swizzledSelector:@selector(zfc_viewDidLoad)];
        [self swizzlingWithOriginalSelector:@selector(viewDidAppear:) swizzledSelector:@selector(zfc_viewDidAppear:)];
...
- (void)zfc_viewDidLoad {
    
    [self zfc_viewDidLoad];
...
- (void)zfc_viewDidAppear:(BOOL)animated {
    
    [self zfc_viewDidAppear:animated];
