...
+ (instancetype)defaultConfiguration {
    return [CWLateralSlideConfiguration configurationWithDistance:kCWSCREENWIDTH * 0.8 maskAlpha:0.6 scaleY:1.0 direction:CWDrawerTransitionFromLeft backImage:nil];
}
